...
Label(
    ...
    font="Times 20",fg="#000",
    relief="raised",
).pack(pady=10)

Label(
    root,text="Enter a number between 1 and 10",
    font ="Times 20",relief="flat",
    fg="#000",
).pack(pady=5)

Entry(
    root, textvariable= number,
    font=("san sarif",20)
).pack(pady=(30,10)) 

Button(
    root, text="Sumbit Guess",
    font=("Times 20"),command= compare_and_check
).pack(pady=30)

Label(
    root,font=("helvetica 16"),
